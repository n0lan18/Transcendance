...
from myapp.views_oauth import FortyTwoLoginView
from myapp.views_oauth import LogoutView
...
urlpatterns = [ 
    ...
    path('api/add-winner-match-tournament/', AddWinnerMatchTournamentView.as_view(), name='add-winner-match-tournament'),
     # 42 OAuth API 엔드포인트 추가
    path('api/auth/42/', FortyTwoLoginView.as_view(), name='api_42_login'),
